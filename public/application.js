...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://peaceful-bastion-91508.herokuapp.com/',
...
var recipeEvents = __webpack_require__(11);
...
var onRecipe = function onRecipe(event) {
  event.preventDefault();
  console.log('Yay you are in!');

  var data = getFormFields(this);
  api.recipe(data).then(ui.recipeSuccess).catch(ui.recipeFailure);
};
var addHandlers1 = function addHandlers1() {
...
var signInSuccess = function signInSuccess(data) {
  ...
  $('#build_recipe').removeClass('hidden');
  $('#signUp').addClass('hidden');
  $('#recipe-update').removeClass('hidden');
  $('#recipe-delete').removeClass('hidden');
...
var signOutSuccess = function signOutSuccess() {
  ...
  $('#build_recipe').addClass('hidden');
  $('#signUp').removeClass('hidden');
  $('#recipe-update').addClass('hidden');
  $('#recipe-delete').addClass('hidden');
  $('#get_all').addClass('hidden');
...
var recipeApi = __webpack_require__(12);
var recipeUi = __webpack_require__(13);

var onCreateRecipe = function onCreateRecipe(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  recipeApi.createRecipe(data).then(recipeUi.onCreateRecipeSuccess).catch(recipeUi.onCreateRecipeFailure);
...
var onShowRecipe = function onShowRecipe(event) {
  ...
  recipeApi.showRecipe().then(recipeUi.onShowRecipeSuccess).catch(recipeUi.onShowRecipeFailure);
};
...
var onUpdateRecipe = function onUpdateRecipe(event) {
  ...
  var data = getFormFields(event.target);
  console.log('data is ' + data);
  recipeApi.updateRecipe(data).then(recipeUi.onUpdateRecipeSuccess).catch(recipeUi.onUpdateRecipefailure);
};
var onDeleteRecipe = function onDeleteRecipe(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var recipe = data.recipe;
  recipeApi.deleteRecipe(recipe.id).then(recipeUi.onDeleteRecipeSuccess).catch(recipeUi.onDeleteRecipeFailure);
};
...
var onCreateRecipeSuccess = function onCreateRecipeSuccess(data) {
...
var onShowRecipeSuccess = function onShowRecipeSuccess(data) {
  $('#message').text('Example successfully created');
  $('#message').css('background-color', 'green');
  store.recipe = data.recipe;
...
var onShowRecipeFailure = function onShowRecipeFailure(error) {
  $('#message').text('Error on sign in');
  $('#message').css('background-color', 'red');
  console.log('onShowFailure ran. Error is :', error);
};

var onUpdateRecipeSuccess = function onUpdateRecipeSuccess(data) {
  $('#message').text('Example successfully created');
  $('#message').css('background-color', 'green');
...
var onDeleteRecipeSuccess = function onDeleteRecipeSuccess(data) {
  $('#message').text('Example successfully created');
  $('#message').css('background-color', 'green');
  store.recipe = data.recipe;
};

var onDeleteRecipeFailure = function onDeleteRecipeFailure(error) {
  $('#message').text('Error on sign in');
  $('#message').css('background-color', 'red');
...
module.exports = {
  ...
  onShowRecipeSuccess: onShowRecipeSuccess,
  onShowRecipeFailure: onShowRecipeFailure,
  onUpdateRecipeSuccess: onUpdateRecipeSuccess,
  onUpdateRecipeFailure: onUpdateRecipeFailure,
  onDeleteRecipeSuccess: onDeleteRecipeSuccess,
  onDeleteRecipeFailure: onDeleteRecipeFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
